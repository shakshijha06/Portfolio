...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate inputs
    // Validate inputs
if (!firstName || !email || !message || !permission) {
  setStatus("error");
...
setStatus("sending");
  ...
  return (
    <section
      ref={ref}
      id="contact"
      className="bg-[#1a1a2e] w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-gray-900"
    >
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        <div
          data-aos="fade-up"
          className="bg-[#c9ada7] w-full md:w-[85%] lg:w-[75%] p-8 md:p-16 text-white flex flex-col justify-between"
        >
 ...
 name="permission"
  ...
  status === "sending"
    ? "opacity-50 cursor-not-allowed bg-[#4a4e69]/30"
    : status === "success"
      ? "bg-[#9a8c98] border-[#9a8c98] text-white"
      : status === "error"
        ? "bg-red-800 border-red-700 text-white"
        : "hover:bg-white hover:text-[#22223b]"
}`}
                  >
                    {status === "sending" ? (
