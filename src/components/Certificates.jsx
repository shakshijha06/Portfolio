...
hover:scale-105
hover:shadow-[0_0_35px_rgba(255,60,60,0.35)]
transition-all
duration-500
group
"  >
...
const Certificates = () => {
  return (
    <section className="bg-[#c9ada7] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-serif">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-12 md:mb-16 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-medium max-w-2xl mx-auto">
  Certifications that reflect my continuous learning journey in cloud computing, AI, and software development.
</p>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          ...
          >
            <svg className="w-5 h-5 text-[#c9ada7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
