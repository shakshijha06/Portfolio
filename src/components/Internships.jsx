...
<span className="bg-[#4a4e69]/30 text-white text-[10px] font-black tracking-widest uppercase py-1 px-3 rounded-full border border-white/15">          {intern.type || "Internship"}
        </span>
    ...
    <div className="pt-4 border-t border-white/10">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {intern.tech.map((t) => (
          <span
            key={t}
className="px-3 py-1 text-xs font-mono font-bold text-white bg-[#4a4e69]/30 rounded-full border border-white/10 hover:bg-white/20 transition-all"          >
            {t}
          </span>
        ))}
  ...
  return (
    <section className="bg-[#c9ada7] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-serif">
...
Practical experiences where I applied software development skills, collaborated on projects, and built real-world solutions.          </p>
        </div>
