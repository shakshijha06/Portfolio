...
const TechnicalSkills = () => {
  return (
    <section
      id="skills"
      className="bg-[#1a1a2e] pt-24 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-serif"
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" className="mb-16 text-center">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            Technologies and tools I explore and apply while building software,
            AI projects, and research experiments.
          </p>
        </div>
        {/* Skills Grid */}
