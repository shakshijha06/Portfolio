...
import heroImage from "../assets/hero video/Shakshi-Hero.png";
...
<div className="absolute inset-0 bg-black/20 z-10 pointer-events-none" />
      ...
      <div className="hidden lg:flex flex-col gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-50 mix-blend-difference">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-white/60 hover:text-[#c9ada7] transition-all duration-300 transform hover:scale-125"
          aria-label="Email"
        >
          <svg
            className="w-5 h-5"
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a
              ...
              className="text-white/60 hover:text-[#c9ada7]"
              aria-label="Email"
            >
              <svg
                className="w-5 h-5"
          ...
          >
            ...
            <span className="bg-gradient-to-r from-[#f2e9e4] via-[#c9ada7] to-[#9a8c98] bg-clip-text text-transparent">
