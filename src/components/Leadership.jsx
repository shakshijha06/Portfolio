...
//       {/* Timeline line dot */}
//       <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 bg-[#c9ada7] rounded-full border-4 border-black z-30 shadow-[0_0_15px_#c9ada7] group-hover:scale-125 transition-transform duration-300" />
...
//             <span className="bg-[#c9ada7]/20 text-[#c9ada7] text-[10px] font-black tracking-widest uppercase py-1 px-3 rounded-full border border-[#c9ada7]/30">
//               {item.badge}
//             </span>
//           </div>
          
//           <h3 className="text-white text-xl font-black mb-1 tracking-tight group-hover:text-[#c9ada7] transition-colors">
//             {item.title}
//           </h3>
...
// const Leadership = () => {
//   return (
//     <section className="bg-[#1a1a2e] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-serif bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]">
      
//       {/* Torn paper divider at top */}
//       <div className="absolute top-0 left-0 w-full pointer-events-none z-10 transform -translate-y-[1px] rotate-180">
//         <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-12 md:h-20 fill-[#c9ada7]">
...
//           <div className="absolute left-4 md:left-1/2 -translate-x-1/2 top-2 bottom-2 w-[2px] bg-gradient-to-b from-[#c9ada7] via-red-500/50 to-white/10" />
